...
Name - Virti Shah
ID - 20CE135
Aim - A python program to find most common elements and their counts from tuple, list, dictionary.
Github link - https://github.com/Virti7702/Practical2-3-e.git
